      ...
      <CardContent class="w-full flex flex-col items-center p-6">
        <FieldSet>
          <FieldTitle class="text-red-200 font-semibold text-lg text-center">
            Please enter your credentials below to check out manually for today.
          </FieldTitle>
          <FieldGroup>
            <Field>
              <FieldLabel
              ...
              <Input
                ...
                required
              />
              <FieldError class="text-red-500 text-sm"
                >Username is required</FieldError
              >
            </Field>
            <Field>
              <FieldLabel
              ...
              />
              <FieldError class="text-red-500 text-sm"
                >Password is required</FieldError
              >
            </Field>
            <Field>
              <Button
                type="submit"
                class="bg-red-500 hover:bg-red-600 text-white font-semibold text-sm cursor-pointer"
                >Check Out</Button
              >
            </Field>
          </FieldGroup>
